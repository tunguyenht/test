...
public class DiaLogAddStudent extends javax.swing.JDialog {
     ...
     */
    Vector header;//1 chieu
    Vector data;//2 chieu
    DefaultTableModel model;//quan ly 2 vector data, header
    public DiaLogAddStudent(java.awt.Frame parent, boolean modal) {
        
        initComponents();
        header= new Vector();
        header.add("Name of Student"); header.add("Class name");
        data= new Vector();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextFieldClass, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(163, 163, 163)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        row.add(jTextFieldName.getText());
        row.add(jTextFieldClass.getText());
        data.add(row);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
        int i= jTable1.getSelectedRow();//lay vi tri duoc chon
        Vector row= new Vector();
        row= (Vector)data.get(i);
        jTextFieldName.setText((String)row.get(0));
        jTextFieldClass.setText((String)row.get(1));
